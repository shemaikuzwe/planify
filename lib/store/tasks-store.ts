...
class TasksStore {
    ...
    async addPage(name: string, userId: string) {
        ...
        await this.db.taskStatus.add({ name: "TODO", categoryId: pageId, createdAt: new Date(), updatedAt: new Date(), id: todoStatusId, primaryColor: "bg-gray-600", tasks: [] })
        await this.db.taskStatus.add({ name: "IN PROGRESS", categoryId: pageId, createdAt: new Date(), updatedAt: new Date(), id: inProgressStatusId, primaryColor: "bg-blue-600", tasks: [] })
        await this.db.taskStatus.add({ name: "DONE", categoryId: pageId, createdAt: new Date(), updatedAt: new Date(), id: doneStatusId, primaryColor: "bg-green-600", tasks: [] })
